...
// position of the array, the sum of left side of the index 
// ({1,2,3}) and the sum of the right side of the index ({3,2,1}) 
// both equal 6.
...
// and the sum of the right side of the index ({50,-51,1,1}) both 
// equal 1.
...
// the side to the right of N. If you do not find an index that 
...
console.log(findEvenIndex([2,1,3,4,2,3,1]))
